...
public class Plane_Renderer_CorrectAnswer : MonoBehaviour
{
...
/////////////////////////////////////////////////////////////
	...
	bool bool_SetSmoothShade = false;

	float float_StartValueBlurrinness = 2.6f;
    ...
    void Update()
    {
		...
		if(CommunicationCorrectAnswerClass.bool_ActiveCorrectAnswerShader)
		{

			CommunicationCorrectAnswerClass.bool_ActiveCorrectAnswerShader = false;

			float_StartValueBlurrinness = 2.6f;
			BorderBlurriness = float_StartValueBlurrinness;
			bool_SetSmoothShade = true;
