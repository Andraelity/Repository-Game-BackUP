...
public class CustomMaterialSticker_ShaderGUI : ShaderGUI {
	...
	void DoMain () 
	{
		...
		editor.ColorProperty(FindProperty("_ColorGlowHDR"), "ColorGlowHDR");

	
		MaterialProperty slider = FindProperty("_AlphaColor");
